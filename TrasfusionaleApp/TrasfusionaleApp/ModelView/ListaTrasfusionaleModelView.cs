...
namespace TrasfusionaleApp.ModelView
{
    public class ListaTrasfusionaleModelView : INotifyPropertyChanged
    {
        ...
        private ListViewTrasfusionali trasfusionali;
        ...
        public ListViewTrasfusionali _trasfusionali
        {
        ...
        {
            REST<Reparto, ListViewTrasfusionali> rEST = new REST<Reparto, ListViewTrasfusionali>();
            ...
            var response = await rEST.GetSingleJson(DatiTrasfusione.restListTrasfusioniForReparto,headers);
